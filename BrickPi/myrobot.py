...
class MyRobot:
    ...
    def __init__(self, motors, wheelradius, robotwidth):
        ...
        self.interface.sensorEnable(touch_port[0], brickpi.SensorType.SENSOR_TOUCH)
        self.interface.sensorEnable(touch_port[1], brickpi.SensorType.SENSOR_TOUCH)
    ...
    def avoid_obstacle(self, touched_0, touched_1):
        ...
        if touched_0 and touched_1:
            ...
            self.turn(direction[random.randint(0,2)], random.randint(90,175)*math.pi/180)
        elif touched_0:
    ...
    def move_forward_avoid_obstacles(self):
        ...
        angle2 = 10
        while True:
            state_touch_sensor_0 = interface.getSensorValue(touch_port[0])
            state_touch_sensor_1 = interface.getSensorValue(touch_port[1])

            if state_touch_sensor_0 and state_touch_sensor_1:
                #handle obstacle
                touched_0 = state_touch_sensor[0]
                touched_1 = state_touch_sensor[1]
